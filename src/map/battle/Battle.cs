...
public partial class Battle : Scene
{
	...
	{
		Provence = MapGlobals.SelectedProvince;
	}
	...
	public override void OnClose()
	{
		...
		{
			var provenceUp = Globals.MapScene.TileMap.GetProvence(MapGlobals.FactoryPosition + Vector2I.Up);
			if (provenceUp.Owner != "Player") provenceUp.Commanders.First().Insert("Infantry", 2);
			var provenceDown = Globals.MapScene.TileMap.GetProvence(MapGlobals.FactoryPosition + Vector2I.Down);
			if (provenceDown.Owner != "Player") provenceDown.Commanders.First().Insert("Infantry", 2);
			var provenceLeft = Globals.MapScene.TileMap.GetProvence(MapGlobals.FactoryPosition + Vector2I.Left);
			if (provenceLeft.Owner != "Player") provenceLeft.Commanders.First().Insert("Infantry", 2);
			var provenceRight = Globals.MapScene.TileMap.GetProvence(MapGlobals.FactoryPosition + Vector2I.Right);
